...
public class API_URL {
    ...
    public static final String uv_url = url + "mobile/uv";
    public static final String nir_url = url + "apple-prediction-nir";
    public static final String triad_url = url + "apple-prediction-nir";
