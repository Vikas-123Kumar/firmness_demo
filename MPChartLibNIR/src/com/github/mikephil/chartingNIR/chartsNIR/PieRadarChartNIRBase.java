...
import com.github.mikephil.chartingNIR.listener.PieRadarChartTouchListener;
import com.github.mikephil.chartingNIR.utilsNIR.SelectionDetail;
 ...
 */
public abstract class PieRadarChartNIRBase<T extends ChartData<? extends DataSet<? extends EntryNIR>>>
        extends ChartNIR<T> {
    ...
    public PieRadarChartNIRBase(Context context) {
        super(context);
    }

    public PieRadarChartNIRBase(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public PieRadarChartNIRBase(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void calculateOffsets() {
        ...
        if (this instanceof RadarChartNIR) {
            XAxis x = ((RadarChartNIR) this).getXAxis();
     ...
     */
    @SuppressLint("NewApi")
    public void spin(int durationmillis, float fromangle, float toangle, EasingNIR.EasingOption easing) {
        ...
        spinAnimator.setInterpolator(EasingNIR.getEasingFunctionFromOption(easing));
