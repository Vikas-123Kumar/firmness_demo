...
import com.github.mikephil.chartingNIR.highlightNIR.BarHighlighter;
...
import com.github.mikephil.chartingNIR.rendererNIR.BarChartRenderer;
import com.github.mikephil.chartingNIR.rendererNIR.XAxisRendererBarChart;
 ...
 */
public class BarChartNIR extends BarLineChartNIRBase<BarData> implements BarDataProvider {
	...
	public BarChartNIR(Context context) {
		super(context);
	}

	public BarChartNIR(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public BarChartNIR(Context context, AttributeSet attrs, int defStyle) {
	...
	/**
	 * Returns the bounding box of the specified EntryNIR in the specified DataSet. Returns null if the EntryNIR could not be
