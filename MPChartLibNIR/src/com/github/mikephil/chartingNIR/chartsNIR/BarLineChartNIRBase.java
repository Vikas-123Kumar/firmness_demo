...
import com.github.mikephil.chartingNIR.componentsNIR.Legend.LegendPosition;
import com.github.mikephil.chartingNIR.componentsNIR.XAxis;
import com.github.mikephil.chartingNIR.componentsNIR.XAxis.XAxisPosition;
...
import com.github.mikephil.chartingNIR.dataNIR.BarLineScatterCandleBubbleDataSet;
import com.github.mikephil.chartingNIR.dataNIR.EntryNIR;
import com.github.mikephil.chartingNIR.dataNIR.filter.Approximator;
import com.github.mikephil.chartingNIR.highlightNIR.ChartHighlighter;
import com.github.mikephil.chartingNIR.interfaces.BarLineScatterCandleBubbleDataProvider;
import com.github.mikephil.chartingNIR.jobs.MoveViewJob;
import com.github.mikephil.chartingNIR.listener.BarLineChartTouchListener;
import com.github.mikephil.chartingNIR.listener.OnDrawListener;
import com.github.mikephil.chartingNIR.rendererNIR.XAxisRenderer;
import com.github.mikephil.chartingNIR.rendererNIR.YAxisRenderer;
import com.github.mikephil.chartingNIR.highlightNIR.Highlight;
import com.github.mikephil.chartingNIR.utilsNIR.PointD;
...
public abstract class BarLineChartNIRBase<T extends BarLineScatterCandleBubbleData<? extends BarLineScatterCandleBubbleDataSet<? extends EntryNIR>>>
        extends ChartNIR<T> implements BarLineScatterCandleBubbleDataProvider {
    ...
    public BarLineChartNIRBase(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public BarLineChartNIRBase(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public BarLineChartNIRBase(Context context) {
        super(context);
    }
...
//            mAxisRight.setValueFormatter(mDefaultFormatter);
    ...
    @Override
    protected float[] getMarkerPosition(EntryNIR e, Highlight highlight) {

        int dataSetIndex = highlight.getDataSetIndex();
        float xPos = e.getXIndex();
        float yPos = e.getVal();

        if (this instanceof BarChartNIR) {
            ...
            if (this instanceof HorizontalBarChartNIR) {
                ...
                BarEntryNIR entry = (BarEntryNIR) e;
    ...
    /**
     * Returns the position (in pixels) the provided EntryNIR has inside the chart
     * view or null, if the provided EntryNIR is null.
     *
     * @param e
     * @return
     */
    public PointF getPosition(EntryNIR e, AxisDependency axis) {
    ...
    /**
     * returns the EntryNIR object displayed at the touched position of the chart
     *
     * @param x
     * @param y
     * @return
     */
    public EntryNIR getEntryByTouchPoint(float x, float y) {
     ...
     * @return
     */
    public BarLineScatterCandleBubbleDataSet<? extends EntryNIR> getDataSetByTouchPoint(float x, float y) {
        Highlight h = getHighlightByTouchPoint(x, y);
        if (h != null) {
