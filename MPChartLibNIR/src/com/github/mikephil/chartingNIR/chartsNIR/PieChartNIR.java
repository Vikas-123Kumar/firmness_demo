...
import com.github.mikephil.chartingNIR.rendererNIR.PieChartRenderer;
 ...
 */
public class PieChartNIR extends PieRadarChartNIRBase<PieData> {
    ...
    public PieChartNIR(Context context) {
        super(context);
    }

    public PieChartNIR(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public PieChartNIR(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void calcAngles() {
        ...
        for (int i = 0; i < mData.getDataSetCount(); i++) {
            ...
            List<EntryNIR> entries = set.getYVals();
    ...
    public int getDataSetIndexForIndex(int xIndex) {
        ...
        List<? extends DataSet<? extends EntryNIR>> dataSets = mData.getDataSets();
