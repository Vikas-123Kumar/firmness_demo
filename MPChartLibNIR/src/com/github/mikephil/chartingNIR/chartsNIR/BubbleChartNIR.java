...
import com.github.mikephil.chartingNIR.rendererNIR.BubbleChartRenderer;
 ...
 */
public class BubbleChartNIR extends BarLineChartNIRBase<BubbleData> implements BubbleDataProvider {

    public BubbleChartNIR(Context context) {
        super(context);
    }

    public BubbleChartNIR(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public BubbleChartNIR(Context context, AttributeSet attrs, int defStyle) {
