...
import com.github.mikephil.chartingNIR.animationNIR.EasingFunction;
import com.github.mikephil.chartingNIR.componentsNIR.Legend;
import com.github.mikephil.chartingNIR.componentsNIR.MarkerView;
import com.github.mikephil.chartingNIR.dataNIR.ChartData;
...
import com.github.mikephil.chartingNIR.interfaces.ChartInterface;
import com.github.mikephil.chartingNIR.listener.ChartTouchListener;
import com.github.mikephil.chartingNIR.listener.OnChartGestureListener;
import com.github.mikephil.chartingNIR.listener.OnChartValueSelectedListener;
import com.github.mikephil.chartingNIR.rendererNIR.DataRenderer;
import com.github.mikephil.chartingNIR.rendererNIR.LegendRenderer;
 ...
 */
@SuppressLint("NewApi")
public abstract class ChartNIR<T extends ChartData<? extends DataSet<? extends EntryNIR>>> extends
        ViewGroup
     ...
     */
    public ChartNIR(Context context) {
        super(context);
        init();
    }
     ...
     */
    public ChartNIR(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
     ...
     */
    public ChartNIR(Context context, AttributeSet attrs, int defStyle) {
    ...
    // for (int i = 0; i < 3; i++) {
    //
    // ArrayList<EntryNIR> yVals = new ArrayList<EntryNIR>();
    //
    // for (int j = 0; j < 12; j++) {
    // float val = (float) (Math.random() * 100);
    // yVals.add(new EntryNIR(val, j));
    // }
    //
    ...
    protected void drawMarkers(Canvas canvas) {
        ...
        for (int i = 0; i < mIndicesToHighlight.length; i++) {
            ...
            if (xIndex <= mDeltaX && xIndex <= mDeltaX * mAnimator.getPhaseX()) {
                ...
                EntryNIR e = mData.getEntryForHighlight(mIndicesToHighlight[i]);
     ...
     * EntryNIR in the given DataSet.
     *
     * @param e
     * @param highlight
     * @return
     */
    protected abstract float[] getMarkerPosition(EntryNIR e, Highlight highlight);
     ...
     */
    public void animateXY(int durationMillisX, int durationMillisY, EasingNIR.EasingOption easingX,
                          EasingNIR.EasingOption easingY) {
        mAnimator.animateXY(durationMillisX, durationMillisY, easingX, easingY);
    }
     ...
     */
    public void animateX(int durationMillis, EasingNIR.EasingOption easing) {
        mAnimator.animateX(durationMillis, easing);
    }
     ...
     * @param easing         a predefined easing option
     */
    public void animateY(int durationMillis, EasingNIR.EasingOption easing) {
        mAnimator.animateY(durationMillis, easing);
    }
...
//    }
    ...
    /**
     * Get all EntryNIR objects at the given index across all DataSets.
     ...
     * @return
     */
    public List<EntryNIR> getEntriesAtIndex(int xIndex) {

        List<EntryNIR> vals = new ArrayList<EntryNIR>();

        for (int i = 0; i < mData.getDataSetCount(); i++) {

            DataSet<? extends EntryNIR> set = mData.getDataSetByIndex(i);
