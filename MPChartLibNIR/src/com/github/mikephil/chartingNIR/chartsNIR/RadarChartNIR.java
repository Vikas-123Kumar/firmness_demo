...
import com.github.mikephil.chartingNIR.rendererNIR.RadarChartRenderer;
import com.github.mikephil.chartingNIR.rendererNIR.XAxisRendererRadarChart;
import com.github.mikephil.chartingNIR.rendererNIR.YAxisRendererRadarChart;
 ...
 */
public class RadarChartNIR extends PieRadarChartNIRBase<RadarData> {
    ...
    public RadarChartNIR(Context context) {
        super(context);
    }

    public RadarChartNIR(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public RadarChartNIR(Context context, AttributeSet attrs, int defStyle) {
