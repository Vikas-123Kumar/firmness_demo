...
import com.github.mikephil.chartingNIR.rendererNIR.ScatterChartRenderer;
 ...
 */
public class ScatterChartNIR extends BarLineChartNIRBase<ScatterData> implements ScatterDataProvider {
    ...
    public ScatterChartNIR(Context context) {
        super(context);
    }

    public ScatterChartNIR(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ScatterChartNIR(Context context, AttributeSet attrs, int defStyle) {
