...
public class ChartAnimator {
    ...
    public void animateXY(int durationMillisX, int durationMillisY, EasingNIR.EasingOption easingX,
        ...
        ObjectAnimator animatorY = ObjectAnimator.ofFloat(this, "phaseY", 0f, 1f);
        animatorY.setInterpolator(EasingNIR.getEasingFunctionFromOption(easingY));
        animatorY.setDuration(
                durationMillisY);
        ObjectAnimator animatorX = ObjectAnimator.ofFloat(this, "phaseX", 0f, 1f);
        animatorX.setInterpolator(EasingNIR.getEasingFunctionFromOption(easingX));
        animatorX.setDuration(
                durationMillisX);
    ...
    public void animateX(int durationMillis, EasingNIR.EasingOption easing) {
        ...
        ObjectAnimator animatorX = ObjectAnimator.ofFloat(this, "phaseX", 0f, 1f);
        animatorX.setInterpolator(EasingNIR.getEasingFunctionFromOption(easing));
        animatorX.setDuration(durationMillis);
        animatorX.addUpdateListener(mListener);
        animatorX.start();
    }
    ...
    public void animateY(int durationMillis, EasingNIR.EasingOption easing) {
        ...
        ObjectAnimator animatorY = ObjectAnimator.ofFloat(this, "phaseY", 0f, 1f);
        animatorY.setInterpolator(EasingNIR.getEasingFunctionFromOption(easing));
        animatorY.setDuration(durationMillis);
        animatorY.addUpdateListener(mListener);
        animatorY.start();
    }
