...
package com.github.mikephil.chartingNIR.animationNIR;
...
public class EasingNIR {
    ...
    public static EasingFunction getEasingFunctionFromOption(EasingOption easing) {
        switch (easing) {
            default:
            case Linear:
                return EasingNIR.EasingFunctions.Linear;
            case EaseInQuad:
                return EasingNIR.EasingFunctions.EaseInQuad;
            case EaseOutQuad:
                return EasingNIR.EasingFunctions.EaseOutQuad;
            case EaseInOutQuad:
                return EasingNIR.EasingFunctions.EaseInOutQuad;
            case EaseInCubic:
                return EasingNIR.EasingFunctions.EaseInCubic;
            case EaseOutCubic:
                return EasingNIR.EasingFunctions.EaseOutCubic;
            case EaseInOutCubic:
                return EasingNIR.EasingFunctions.EaseInOutCubic;
            case EaseInQuart:
                return EasingNIR.EasingFunctions.EaseInQuart;
            case EaseOutQuart:
                return EasingNIR.EasingFunctions.EaseOutQuart;
            case EaseInOutQuart:
                return EasingNIR.EasingFunctions.EaseInOutQuart;
            case EaseInSine:
                return EasingNIR.EasingFunctions.EaseInSine;
            case EaseOutSine:
                return EasingNIR.EasingFunctions.EaseOutSine;
            case EaseInOutSine:
                return EasingNIR.EasingFunctions.EaseInOutSine;
            case EaseInExpo:
                return EasingNIR.EasingFunctions.EaseInExpo;
            case EaseOutExpo:
                return EasingNIR.EasingFunctions.EaseOutExpo;
            case EaseInOutExpo:
                return EasingNIR.EasingFunctions.EaseInOutExpo;
            case EaseInCirc:
                return EasingNIR.EasingFunctions.EaseInCirc;
            case EaseOutCirc:
                return EasingNIR.EasingFunctions.EaseOutCirc;
            case EaseInOutCirc:
                return EasingNIR.EasingFunctions.EaseInOutCirc;
            case EaseInElastic:
                return EasingNIR.EasingFunctions.EaseInElastic;
            case EaseOutElastic:
                return EasingNIR.EasingFunctions.EaseOutElastic;
            case EaseInOutElastic:
                return EasingNIR.EasingFunctions.EaseInOutElastic;
            case EaseInBack:
                return EasingNIR.EasingFunctions.EaseInBack;
            case EaseOutBack:
                return EasingNIR.EasingFunctions.EaseOutBack;
            case EaseInOutBack:
                return EasingNIR.EasingFunctions.EaseInOutBack;
            case EaseInBounce:
                return EasingNIR.EasingFunctions.EaseInBounce;
            case EaseOutBounce:
                return EasingNIR.EasingFunctions.EaseOutBounce;
            case EaseInOutBounce:
                return EasingNIR.EasingFunctions.EaseInOutBounce;
        }
    }
