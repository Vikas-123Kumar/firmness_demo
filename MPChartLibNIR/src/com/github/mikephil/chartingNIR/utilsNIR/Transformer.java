...
public class Transformer {
    ...
    /**
     * Transforms an List of EntryNIR into a float array containing the x and
     * y values transformed with all matrices for the SCATTERCHART.
     *
     * @param entries
     * @return
     */
    public float[] generateTransformedValuesScatter(List<? extends EntryNIR> entries,
                                                    float phaseY) {
     ...
     * @return
     */
    public float[] generateTransformedValuesBubble(List<? extends EntryNIR> entries,
        ...
        for (int j = 0; j < count; j += 2) {
            ...
            EntryNIR e = entries.get(j / 2 + from);
     ...
     * @return
     */
    public float[] generateTransformedValuesLine(List<? extends EntryNIR> entries,
                                                 float phaseX, float phaseY, int from, int to) {
     ...
     * @return
     */
    public float[] generateTransformedValuesCandle(List<CandleEntryNIR> entries,
                                                   float phaseX, float phaseY, int from, int to) {
        ...
        for (int j = 0; j < count; j += 2) {
            ...
            CandleEntryNIR e = entries.get(j / 2 + from);
     ...
     * @return
     */
    public float[] generateTransformedValuesBarChart(List<? extends EntryNIR> entries,
     ...
     * @return
     */
    public float[] generateTransformedValuesHorizontalBarChart(List<? extends EntryNIR> entries,
                                                               int dataSet, BarData bd, float phaseY) {
