...
public abstract class MarkerView extends RelativeLayout {
     ...
     *
     * @param e         The EntryNIR the MarkerView belongs to. This can also be any subclass of EntryNIR, like BarEntryNIR or
     *                  CandleEntryNIR, simply cast it at runtime.
     * @param highlight the highlight object contains information about the highlighted value such as it's dataset-index, the
     *                  selected range or stack-index (only stacked bar entries).
     */
    public abstract void refreshContent(EntryNIR e, Highlight highlight);
