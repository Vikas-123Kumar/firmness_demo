package com.github.mikephil.chartingNIR.highlightNIR;
...
public class BarHighlighter extends ChartHighlighter<BarDataProvider> {
	...
	/**
	 * This method creates the Highlight object that also indicates which value of a stacked BarEntryNIR has been selected.
	 *
	 * @param old
	...
	protected Highlight getStackedHighlight(Highlight old, BarDataSet set, int xIndex, int dataSetIndex, double yValue) {
		...
		BarEntryNIR entry = set.getEntryForXIndex(xIndex);
	 ...
	 * @return
	 */
	protected Range[] getRanges(BarEntryNIR entry) {
