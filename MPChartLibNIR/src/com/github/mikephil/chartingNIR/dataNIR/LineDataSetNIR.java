...
import com.github.mikephil.chartingNIR.formatterNIR.DefaultFillFormatter;
import com.github.mikephil.chartingNIR.formatterNIR.FillFormatter;
import com.github.mikephil.chartingNIR.utilsNIR.Utils;

import java.util.ArrayList;
import java.util.List;

public class LineDataSetNIR extends LineRadarDataSet<EntryNIR> {
    ...
    public LineDataSetNIR(List<EntryNIR> yVals, String label) {
        super(yVals, label);
    ...
    public DataSet<EntryNIR> copy() {
        ...
        LineDataSetNIR copied = new LineDataSetNIR(yVals, getLabel());
