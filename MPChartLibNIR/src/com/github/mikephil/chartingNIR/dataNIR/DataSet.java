...
import com.github.mikephil.chartingNIR.utilsNIR.ColorTemplate;
import com.github.mikephil.chartingNIR.formatterNIR.DefaultValueFormatter;
...
/**
 * The DataSet class represents one group or type of entries (EntryNIR) in the
 ...
 */
public abstract class DataSet<T extends EntryNIR> {
    ...
    /**
     * Returns the value of the EntryNIR object at the given xIndex. Returns
    ...
    public float getYValForXIndex(int xIndex) {
        ...
        EntryNIR e = getEntryForXIndex(xIndex);
    ...
    /**
     * Returns the first EntryNIR object found at the given xIndex with binary
     * search. If the no EntryNIR at the specified x-index is found, this method
     * returns the index at the closest x-index. Returns null if no EntryNIR object
    ...
    /**
     * Returns the first EntryNIR index found at the given xIndex with binary
     * search. If the no EntryNIR at the specified x-index is found, this method
     * returns the index at the closest x-index. Returns -1 if no EntryNIR object
     * at that index. INFORMATION: This method does calculations at runtime. Do
     * not over-use in performance critical situations.
     *
     * @param x
    ...
    /**
     * Returns all EntryNIR objects at the given xIndex. INFORMATION: This method
     * does calculations at runtime. Do not over-use in performance critical
     * situations.
     *
     * @param x
    ...
    /**
     * returns the DataSets EntryNIR array
     *
     * @return
     */
    ...
    /**
     * The xIndex of an EntryNIR object is provided. This method returns the actual
     * index in the EntryNIR array of the DataSet. IMPORTANT: This method does
    ...
    /**
     * Adds an EntryNIR to the DataSet dynamically.
    ...
    public void addEntry(EntryNIR e) {
     ...
     */
    @SuppressWarnings("unchecked")
    public void addEntryOrdered(EntryNIR e) {
    ...
    /**
     * Removes an EntryNIR from the DataSets entries array. This will also
     * recalculate the current minimum and maximum values of the DataSet and the
     * value-sum. Returns true if an EntryNIR was removed, false if no EntryNIR could
     * be removed.
     *
     * @param e
     */
    ...
    /**
     * Removes the EntryNIR object that has the given xIndex from the DataSet.
     * Returns true if an EntryNIR was removed, false if no EntryNIR could be removed.
     *
     * @param xIndex
     */
    ...
    /**
     * Removes the first EntryNIR (at index 0) of this DataSet from the entries array.
    ...
    /**
     * Removes the last EntryNIR (at index size-1) of this DataSet from the entries array.
     * Returns true if successful, false if not.
     *
     * @return
     */
    ...
    /**
     * Returns the position of the provided entry in the DataSets EntryNIR array.
     * Returns -1 if doesn't exist.
     *
     * @param e
     * @return
     */
    public int getEntryPosition(EntryNIR e) {
    ...
    /**
     * Checks if this DataSet contains the specified EntryNIR. Returns true if so,
     ...
     * @return
     */
    public boolean contains(EntryNIR e) {

        for (EntryNIR entryNIR : mYVals) {
            if (entryNIR.equals(e))
                return true;
        }
