...
import com.github.mikephil.chartingNIR.chartsNIR.ScatterChartNIR;

import java.util.ArrayList;
import java.util.List;

public class ScatterDataSet extends LineScatterCandleRadarDataSet<EntryNIR> {
     ...
     */
    private ScatterChartNIR.ScatterShape mScatterShape = ScatterChartNIR.ScatterShape.SQUARE;
    ...
    public ScatterDataSet(List<EntryNIR> yVals, String label) {
        super(yVals, label);
     ...
     * @param shape
     */
    public void setScatterShape(ScatterChartNIR.ScatterShape shape) {
        mScatterShape = shape;
    }
     ...
     * @return
     */
    public ScatterChartNIR.ScatterShape getScatterShape() {
