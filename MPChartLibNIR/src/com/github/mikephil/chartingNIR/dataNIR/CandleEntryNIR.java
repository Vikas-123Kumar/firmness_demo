...
/**
 * Subclass of EntryNIR that holds all values for one entry in a CandleStickChart.
 * 
 * @author Philipp Jahoda
 */
public class CandleEntryNIR extends EntryNIR {
     ...
     */
    public CandleEntryNIR(int xIndex, float shadowH, float shadowL, float open, float close) {
    ...
    public CandleEntryNIR copy() {

        CandleEntryNIR c = new CandleEntryNIR(getXIndex(), mShadowHigh, mShadowLow, mOpen,
                mClose, getData());
