 ...
 */
public abstract class ChartData<T extends DataSet<? extends EntryNIR>> {
     ...
     *              as the highest xIndex in the EntryNIR objects across all
     *              DataSets.
        ...
        for (int i = 0; i < mDataSets.size(); i++) {
            if (mDataSets.get(i)
                ...
                throw new IllegalArgumentException(
                        "One or more of the DataSet EntryNIR arrays are longer than the x-values array of this ChartData object.");
            }
        }
    }
    ...
    /**
     * Get the EntryNIR for a corresponding highlight object
     *
     * @param highlight
     * @return the entry that is highlighted
     */
    public EntryNIR getEntryForHighlight(Highlight highlight) {
    ...
    /**
     * Adds an EntryNIR to the DataSet at the specified index.
     * Entries are added to the end of the list.
     *
     * @param e
     * @param dataSetIndex
     */
    public void addEntry(EntryNIR e, int dataSetIndex) {
        ...
        if (mDataSets.size() > dataSetIndex && dataSetIndex >= 0) {
            ...
            Log.e("addEntry", "Cannot add EntryNIR because dataSetIndex too high or too low.");
        }
    }

    /**
     * Removes the given EntryNIR object from the DataSet at the specified index.
     *
     * @param e
     * @param dataSetIndex
     */
    public boolean removeEntry(EntryNIR e, int dataSetIndex) {
    ...
    /**
     * Removes the EntryNIR object at the given xIndex from the DataSet at the
     * specified index. Returns true if an EntryNIR was removed, false if no EntryNIR
    ...
    public boolean removeEntry(int xIndex, int dataSetIndex) {
        ...
        EntryNIR e = dataSet.getEntryForXIndex(xIndex);
    ...
    /**
     * Returns the DataSet that contains the provided EntryNIR, or null, if no
     * DataSet contains this EntryNIR.
     *
     * @param e
     * @return
     */
    public T getDataSetForEntry(EntryNIR e) {
    ...
    /**
     * Checks if this data object contains the specified EntryNIR. Returns true if
