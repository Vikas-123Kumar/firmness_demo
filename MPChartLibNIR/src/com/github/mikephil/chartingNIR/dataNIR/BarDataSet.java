...
public class BarDataSet extends BarLineScatterCandleBubbleDataSet<BarEntryNIR> {
    ...
    public BarDataSet(List<BarEntryNIR> yVals, String label) {
        super(yVals, label);
    ...
    @Override
    public DataSet<BarEntryNIR> copy() {

        List<BarEntryNIR> yVals = new ArrayList<BarEntryNIR>();

        for (int i = 0; i < mYVals.size(); i++) {
            yVals.add(((BarEntryNIR) mYVals.get(i)).copy());
        }
     ...
     */
    private void calcEntryCountIncludingStacks(List<BarEntryNIR> yVals) {
     ...
     * DataSet
     */
    private void calcStackSize(List<BarEntryNIR> yVals) {
