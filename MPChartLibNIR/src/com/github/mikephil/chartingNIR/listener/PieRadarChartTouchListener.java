...
import com.github.mikephil.chartingNIR.chartsNIR.PieRadarChartNIRBase;
 ...
 */
public class PieRadarChartTouchListener extends ChartTouchListener<PieRadarChartNIRBase<?>> {
    ...
    public PieRadarChartTouchListener(PieRadarChartNIRBase<?> chart) {
        super(chart);
    }
    ...
    public boolean onSingleTapUp(MotionEvent e) {
        ...
        if (distance > mChart.getRadius()) {
            ...
            if (mChart instanceof PieChartNIR) {
            ...
            if (index < 0) {
                ...
                // only
                // has one DataSet)
                if (mChart instanceof RadarChartNIR) {

                    dataSetIndex = Utils.getClosestDataSetIndex(valsAtIndex, distance
                            / ((RadarChartNIR) mChart).getFactor(), null);
                }
