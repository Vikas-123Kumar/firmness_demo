...
import com.github.mikephil.chartingNIR.chartsNIR.PieChartNIR;
import com.github.mikephil.chartingNIR.dataNIR.EntryNIR;
import com.github.mikephil.chartingNIR.dataNIR.PieData;
import com.github.mikephil.chartingNIR.dataNIR.PieDataSet;
...
public class PieChartRenderer extends DataRenderer {
    ...
    public PieChartRenderer(PieChartNIR chart, ChartAnimator animator,
    ...
    public void drawValues(Canvas c) {
        ...
        for (int i = 0; i < dataSets.size(); i++) {
            ...
            for (int j = 0, maxEntry = Math.min(
                ...
                float value = mChart.isUsePercentValuesEnabled() ? entryNIR.getVal()
                        / data.getYValueSum() * 100f : entryNIR.getVal();
                ...
                if (drawXVals && drawYVals) {
                    ...
                    drawValue(c, formatter, value, entryNIR, 0, x, y);
                    ...
                    drawValue(c, formatter, value, entryNIR, 0, x, y + lineHeight / 2f);
                }
