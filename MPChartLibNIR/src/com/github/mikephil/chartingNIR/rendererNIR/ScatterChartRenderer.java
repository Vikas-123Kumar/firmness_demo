...
import com.github.mikephil.chartingNIR.bufferNIR.ScatterBuffer;
import com.github.mikephil.chartingNIR.chartsNIR.ScatterChartNIR.ScatterShape;
import com.github.mikephil.chartingNIR.dataNIR.EntryNIR;
import com.github.mikephil.chartingNIR.dataNIR.ScatterData;
import com.github.mikephil.chartingNIR.dataNIR.ScatterDataSet;
        ...
        if (mChart.getScatterData().getYValCount() < mChart.getMaxVisibleCount()
            ...
            for (int i = 0; i < mChart.getScatterData().getDataSetCount(); i++) {
                ...
                for (int j = 0; j < positions.length * mAnimator.getPhaseX(); j += 2) {
                    ...
                    EntryNIR entryNIR = entries.get(j / 2);

                    drawValue(c, dataSet.getValueFormatter(), entryNIR.getVal(), entryNIR, i, positions[j],
