...
import com.github.mikephil.chartingNIR.bufferNIR.CandleBodyBuffer;
import com.github.mikephil.chartingNIR.bufferNIR.CandleShadowBuffer;
import com.github.mikephil.chartingNIR.dataNIR.CandleData;
import com.github.mikephil.chartingNIR.dataNIR.CandleDataSet;
...
public class CandleStickChartRenderer extends LineScatterCandleRadarRenderer {
    ...
    protected void drawDataSet(Canvas c, CandleDataSet dataSet) {
        ...
        List<CandleEntryNIR> entries = dataSet.getYVals();
        ...
        for (int j = 0; j < range; j += 4) {
            ...
            // get the entry
            CandleEntryNIR e = entries.get(j / 4 + minx);
    ...
    // * @param bodySpace
    // */
    // private void transformBody(float[] bodyPoints, CandleEntryNIR e, float
    ...
    // * @param e
    // */
    // private void transformShadow(float[] shadowPoints, CandleEntryNIR e,
    // Transformer trans) {
    //
    // float phase = mAnimator.getPhaseY();
    //
        ...
        if (mChart.getCandleData().getYValCount() < mChart.getMaxVisibleCount()
            ...
            for (int i = 0; i < dataSets.size(); i++) {
                ...
                for (int j = 0; j < positions.length; j += 2) {
                    ...
                    CandleEntryNIR entry = entries.get(j / 2 + minx);
    ...
    public void drawHighlighted(Canvas c, Highlight[] indices) {
        ...
        for (int i = 0; i < indices.length; i++) {
            ...
            CandleEntryNIR e = set.getEntryForXIndex(xIndex);
