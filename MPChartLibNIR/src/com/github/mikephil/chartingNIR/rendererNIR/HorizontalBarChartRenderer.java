...
import com.github.mikephil.chartingNIR.bufferNIR.BarBuffer;
import com.github.mikephil.chartingNIR.bufferNIR.HorizontalBarBuffer;
...
public class HorizontalBarChartRenderer extends BarChartRenderer {
    ...
    protected void drawDataSet(Canvas c, BarDataSet dataSet, int index) {
        ...
        List<BarEntryNIR> entries = dataSet.getYVals();
    ...
    @Override
    public float[] getTransformedValues(Transformer trans, List<BarEntryNIR> entries,
            int dataSetIndex) {
